...
export default function Register_otp({ navigation, route }) {
        ...
        try {
            ...
            firebase.auth().signInWithCredential(credential).then(() => {
                ...
                if (sanitizedNumber.length < 13 && sanitizedNumber.startsWith('84')) {
                    ...
                    navigation.push("Register_userInfo", { username: username, phonenumber: convertedNumber, password: password })
                } else {
